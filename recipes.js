...
const ING = {
  ...
  betterave: ["Betteraves cuites", "legumes"], orange: ["Orange", "legumes"],
  ...
  agneau: ["Épaule d'agneau (morceaux)", "boucherie"], sardines: ["Sardines fraîches (en filets)", "boucherie"], calamars: ["Anneaux de calamar", "boucherie"], boeuf_saute: ["Bœuf à sauter (émincé)", "boucherie"], roti_boeuf: ["Rôti de bœuf", "boucherie"], truite: ["Truites (vidées)", "boucherie"],
  // Crèmerie & œufs
  ...
  cajou: ["Noix de cajou", "epicerie"], abricots_secs: ["Abricots secs", "epicerie"], feuilles_vigne: ["Feuilles de vigne (bocal)", "epicerie"], melasse_grenade: ["Mélasse de grenade", "epicerie"], feves: ["Fèves cuites (boîte 400 g)", "epicerie"],
  // Surgelés
  petits_pois: ["Petits pois", "surgeles"], artichauts: ["Fonds d'artichauts (surgelés)", "surgeles"],
  // Boulangerie
  pain: ["Pain de campagne", "boulangerie"], pain_burger: ["Pains à burger", "boulangerie"], pita: ["Pains pita", "boulangerie"], msemen: ["Msemen (ou crêpes épaisses)", "boulangerie"], batbout: ["Batbout (petits pains marocains)", "boulangerie"],
};
...
const RECIPES = [
  ...
  /* ---------- Marocaines (suite) ---------- */
  { id: "rfissa", name: "Rfissa au poulet (msemen, lentilles et fenugrec)", cat: "volaille", cui: "ma", time: 80, slots: ["soir"],
    img: "https://thumb.wikimedia.org/wikipedia/commons/thumb/5/5f/Rfissa_marocaine.jpg/500px-Rfissa_marocaine.jpg", imgPage: "https://fr.wikipedia.org/wiki/Rfissa",
    ing: [["poulet_cuisse", 2, "pc"], ["msemen", 6, "pc"], ["lentilles_vertes", 120, "g"], ["oignon", 3, "pc"], ["ail", 2, "gousse"], ["coriandre", 1, "botte"], ["persil", 1, "botte"], ["bouillon", 1, "pc"]],
    pantry: ["fenugrec (graines)", "ras el hanout", "curcuma", "gingembre moulu", "safran (ou curcuma)", "huile d'olive", "sel", "poivre"],
    steps: ["Faites tremper 1 cuillère à soupe de graines de fenugrec dans l'eau tiède pendant que vous préparez le reste (idéalement 1 heure). Rincez 120 g de lentilles.",
      "Dans une cocotte, faites dorer les 2 cuisses de poulet dans 2 cuillères d'huile d'olive. Ajoutez les 3 oignons émincés, l'ail, 1 cuillère à café de ras el hanout, 1 de curcuma, 1 de gingembre, une pincée de safran, sel, poivre. Mélangez 5 minutes.",
      "Ajoutez les lentilles, le fenugrec égoutté, la moitié des herbes ciselées, le cube de bouillon et 80 cl d'eau. Couvrez et laissez mijoter 45 minutes : le poulet doit se détacher et la sauce épaissir.",
      "Réchauffez les msemen 1 minute à la vapeur ou à la poêle, coupez-les en lanières et étalez-les dans un grand plat.",
      "Versez la sauce aux lentilles sur les msemen, posez le poulet dessus, parsemez du reste des herbes. Servez aussitôt."] },

  { id: "tajine-boeuf-petits-pois", name: "Tajine de bœuf aux pommes de terre et petits pois", cat: "viande", cui: "ma", time: 75, slots: ["soir"],
    img: "https://thumb.wikimedia.org/wikipedia/commons/thumb/6/6d/Tajine_008.JPG/500px-Tajine_008.JPG", imgPage: "https://fr.wikipedia.org/wiki/Tajine",
    ing: [["boeuf_braiser", 500, "g"], ["pdt", 500, "g"], ["petits_pois", 200, "g"], ["oignon", 1, "pc"], ["ail", 2, "gousse"], ["tomate", 2, "pc"], ["coriandre", 1, "botte"], ["olives_vertes", 60, "g"]],
    pantry: ["cumin", "paprika", "curcuma", "gingembre moulu", "huile d'olive", "sel", "poivre"],
    steps: ["Coupez 500 g de bœuf en cubes. Dans une cocotte, faites-les colorer dans 2 cuillères d'huile d'olive avec l'oignon haché, l'ail, 1 cuillère à café de cumin, 1 de paprika, 1 de curcuma, 1/2 de gingembre, sel, poivre. 5 minutes.",
      "Ajoutez les 2 tomates râpées et 30 cl d'eau, couvrez et laissez mijoter 45 minutes à feu doux.",
      "Épluchez 500 g de pommes de terre, coupez-les en quartiers et posez-les sur la viande avec la moitié de la coriandre. Couvrez, 20 minutes.",
      "Ajoutez 200 g de petits pois et les olives, 8 minutes. La sauce doit être réduite et nappante.",
      "Parsemez du reste de coriandre et servez avec du pain."] },

  { id: "tajine-poulet-abricots", name: "Tajine de poulet aux abricots secs et amandes", cat: "volaille", cui: "ma", time: 60, slots: ["soir"],
    img: "https://thumb.wikimedia.org/wikipedia/commons/thumb/6/6d/Tajine_008.JPG/500px-Tajine_008.JPG", imgPage: "https://fr.wikipedia.org/wiki/Tajine",
    ing: [["poulet_haut", 4, "pc"], ["abricots_secs", 150, "g"], ["amandes", 40, "g"], ["oignon", 2, "pc"], ["ail", 2, "gousse"], ["miel", 1, "cs"], ["sesame", 1, "cs"], ["semoule", 150, "g"]],
    pantry: ["cannelle", "gingembre moulu", "curcuma", "safran (ou curcuma)", "huile d'olive", "sel", "poivre"],
    steps: ["Faites dorer les 4 hauts de cuisse salés et poivrés dans 2 cuillères d'huile d'olive, 4 minutes par face. Réservez.",
      "Faites fondre les 2 oignons émincés 5 minutes, ajoutez l'ail, 1 cuillère à café de gingembre, 1 de curcuma, 1/2 de cannelle, une pincée de safran. Remettez le poulet, versez 25 cl d'eau, couvrez, 30 minutes.",
      "Ajoutez 150 g d'abricots secs et 1 cuillère de miel, poursuivez 12 minutes à découvert pour que la sauce épaississe.",
      "Faites griller 40 g d'amandes effilées à sec. Préparez 150 g de semoule (même volume d'eau bouillante salée, 5 minutes à couvert).",
      "Servez le tajine parsemé d'amandes et de sésame, avec la semoule."] },

  { id: "tajine-agneau-artichauts", name: "Tajine d'agneau aux artichauts et petits pois", cat: "viande", cui: "ma", time: 80, slots: ["soir"],
    img: "https://thumb.wikimedia.org/wikipedia/commons/thumb/6/6d/Tajine_008.JPG/500px-Tajine_008.JPG", imgPage: "https://fr.wikipedia.org/wiki/Tajine",
    ing: [["agneau", 500, "g"], ["artichauts", 6, "pc"], ["petits_pois", 200, "g"], ["oignon", 1, "pc"], ["ail", 2, "gousse"], ["citron_confit", 1, "pc"], ["coriandre", 1, "botte"], ["citron", 1, "pc"]],
    pantry: ["curcuma", "gingembre moulu", "safran (ou curcuma)", "huile d'olive", "sel", "poivre"],
    steps: ["Coupez 500 g d'agneau en morceaux. Faites-les colorer dans 2 cuillères d'huile d'olive avec l'oignon haché, l'ail, 1 cuillère à café de curcuma, 1 de gingembre, une pincée de safran, sel, poivre.",
      "Couvrez d'eau à hauteur, ajoutez la moitié de la coriandre, couvrez et laissez mijoter 50 minutes.",
      "Ajoutez les 6 fonds d'artichauts (surgelés, sans décongeler), le citron confit en quartiers et le jus d'un demi-citron. 15 minutes.",
      "Ajoutez 200 g de petits pois, 8 minutes. Rectifiez le sel.",
      "Parsemez du reste de coriandre. Servez avec du pain."] },

  { id: "boulettes-sardines", name: "Boulettes de sardines à la chermoula, sauce tomate", cat: "poisson", cui: "ma", time: 40, slots: ["soir"], diet: ["leger", "chol"],
    ing: [["sardines", 600, "g"], ["tomates_concassees", 1, "boite"], ["oignon", 1, "pc"], ["ail", 4, "gousse"], ["coriandre", 1, "botte"], ["persil", 1, "botte"], ["citron", 1, "pc"], ["riz", 150, "g"], ["poivron", 1, "pc"]],
    pantry: ["cumin", "paprika", "piment doux", "huile d'olive", "sel", "poivre"],
    steps: ["Demandez au poissonnier des sardines en filets, sans arêtes (600 g). Hachez-les au couteau ou au mixeur par impulsions.",
      "Mélangez la chair avec 2 gousses d'ail pressées, la moitié de la coriandre et du persil ciselés, 1 cuillère à café de cumin, 1 de paprika, une pointe de piment, le zeste du citron, sel. Formez des boulettes de la taille d'une noix.",
      "Sauce : faites revenir l'oignon haché, 2 gousses d'ail et le poivron en dés dans 2 cuillères d'huile d'olive, ajoutez la boîte de tomates, 1 cuillère à café de cumin et de paprika, sel. Mijotez 10 minutes.",
      "Déposez les boulettes dans la sauce, couvrez, 15 minutes à feu doux en les retournant à mi-cuisson. Faites cuire 150 g de riz pendant ce temps.",
      "Parsemez du reste des herbes, un trait de citron. Servez avec le riz."] },

  { id: "seffa-medfouna", name: "Seffa medfouna (poulet caché sous les vermicelles, cannelle et amandes)", cat: "volaille", cui: "ma", time: 70, slots: ["soir"],
    img: "https://thumb.wikimedia.org/wikipedia/commons/thumb/0/0f/Seffa.jpg/500px-Seffa.jpg", imgPage: "https://fr.wikipedia.org/wiki/Seffa",
    ing: [["poulet_cuisse", 2, "pc"], ["vermicelles", 300, "g"], ["oignon", 2, "pc"], ["amandes", 60, "g"], ["raisins_secs", 40, "g"], ["beurre", 40, "g"], ["bouillon", 1, "pc"]],
    pantry: ["cannelle", "sucre glace", "curcuma", "gingembre moulu", "safran (ou curcuma)", "huile d'olive", "sel", "poivre"],
    steps: ["Dans une cocotte, faites dorer les 2 cuisses de poulet dans 1 cuillère d'huile, ajoutez les oignons émincés, 1 cuillère à café de curcuma, 1 de gingembre, une pincée de safran, sel, poivre. Couvrez de 50 cl d'eau avec le cube de bouillon, mijotez 40 minutes.",
      "Faites cuire 300 g de vermicelles à la vapeur (couscoussier) ou à l'eau bouillante 3 minutes, égouttez, mélangez avec 40 g de beurre, une louche de sauce et 40 g de raisins secs.",
      "Faites dorer 60 g d'amandes à sec, concassez-les grossièrement.",
      "Désossez le poulet, effilochez-le grossièrement et gardez-le dans sa sauce aux oignons.",
      "Dressez : une couche de vermicelles, le poulet et les oignons au centre, recouvrez de vermicelles en dôme. Décorez de lignes de cannelle et de sucre glace, parsemez d'amandes."] },

  { id: "pastilla-poulet", name: "Pastilla au poulet et aux amandes", cat: "volaille", cui: "ma", time: 90, slots: ["soir"],
    img: "https://thumb.wikimedia.org/wikipedia/commons/thumb/e/ed/Bisteeya.jpg/500px-Bisteeya.jpg", imgPage: "https://fr.wikipedia.org/wiki/Pastilla",
    ing: [["poulet_cuisse", 2, "pc"], ["brick", 10, "feuille"], ["oignon", 2, "pc"], ["oeuf", 3, "pc"], ["amandes", 100, "g"], ["beurre", 50, "g"], ["persil", 1, "botte"], ["coriandre", 1, "botte"]],
    pantry: ["cannelle", "sucre glace", "sucre", "curcuma", "gingembre moulu", "safran (ou curcuma)", "huile d'olive", "sel", "poivre"],
    steps: ["Faites dorer les 2 cuisses de poulet avec les oignons émincés, 1 cuillère à café de curcuma, 1 de gingembre, 1/2 de cannelle, une pincée de safran, les herbes ciselées, sel, poivre. Ajoutez 30 cl d'eau, couvrez, 35 minutes. Désossez et effilochez le poulet.",
      "Faites réduire la sauce aux oignons à feu vif jusqu'à évaporation presque complète, puis versez 3 œufs battus en remuant pour obtenir une farce crémeuse. Coupez le feu.",
      "Faites griller 100 g d'amandes, concassez-les et mélangez avec 1 cuillère de sucre et 1/2 cuillère à café de cannelle.",
      "Préchauffez le four à 190 °C. Beurrez un moule rond. Tapissez-le de 6 feuilles de brick beurrées en les faisant dépasser. Étalez la farce aux œufs, puis le poulet, puis les amandes. Rabattez les feuilles, couvrez avec les 4 restantes beurrées, rentrez les bords.",
      "Enfournez 25 minutes jusqu'à ce que la pastilla soit dorée. Retournez-la sur un plat, saupoudrez de sucre glace et tracez des lignes de cannelle."] },

  { id: "mrouzia", name: "Mrouzia (agneau au miel, raisins secs et ras el hanout)", cat: "viande", cui: "ma", time: 100, slots: ["soir"],
    img: "https://thumb.wikimedia.org/wikipedia/commons/thumb/e/e9/IB_tajine_02.jpg/500px-IB_tajine_02.jpg", imgPage: "https://fr.wikipedia.org/wiki/Mrouzia",
    ing: [["agneau", 600, "g"], ["raisins_secs", 100, "g"], ["amandes", 50, "g"], ["miel", 3, "cs"], ["oignon", 1, "pc"], ["beurre", 30, "g"], ["semoule", 150, "g"]],
    pantry: ["ras el hanout", "cannelle", "gingembre moulu", "safran (ou curcuma)", "huile d'olive", "sel", "poivre"],
    steps: ["Coupez 600 g d'agneau en gros morceaux. Mélangez-les avec 1 cuillère à soupe de ras el hanout, 1 cuillère à café de cannelle, 1 de gingembre, une pincée de safran, sel, poivre. Laissez reposer 15 minutes.",
      "Dans une cocotte, faites revenir la viande avec l'oignon râpé dans 30 g de beurre et 1 cuillère d'huile 5 minutes. Couvrez d'eau à hauteur, couvrez, mijotez 1 h 15 à feu doux.",
      "Ajoutez 100 g de raisins secs et 3 cuillères de miel, poursuivez 15 minutes à découvert jusqu'à ce que la sauce devienne sirupeuse.",
      "Faites griller 50 g d'amandes. Préparez 150 g de semoule.",
      "Servez la viande nappée de sa sauce, parsemée d'amandes, avec la semoule. Plat de fête, très parfumé : une petite portion suffit."] },

  { id: "tangia", name: "Tangia de bœuf à la marrakchia (citron confit, cumin, cuisson lente)", cat: "viande", cui: "ma", time: 150, slots: ["soir"],
    img: "https://thumb.wikimedia.org/wikipedia/commons/thumb/f/f4/Tanjia-959.jpg/500px-Tanjia-959.jpg", imgPage: "https://fr.wikipedia.org/wiki/Tangia",
    ing: [["boeuf_braiser", 700, "g"], ["ail", 6, "gousse"], ["citron_confit", 1, "pc"], ["oignon", 1, "pc"], ["pain", 4, "tranche"]],
    pantry: ["cumin", "ras el hanout", "safran (ou curcuma)", "huile d'olive", "sel", "poivre"],
    steps: ["Coupez 700 g de bœuf à braiser en gros morceaux. Dans une cocotte en fonte, mélangez-les avec 6 gousses d'ail écrasées, le citron confit en morceaux, l'oignon haché, 1 cuillère à soupe de cumin, 1 cuillère à café de ras el hanout, une pincée de safran, 4 cuillères d'huile d'olive, sel, poivre.",
      "Versez 25 cl d'eau, fermez hermétiquement (papier cuisson sous le couvercle) et enfournez à 150 °C pendant 2 h 30 sans ouvrir. La viande doit se défaire à la cuillère et la sauce être confite.",
      "Servez dans la cocotte, avec du pain pour saucer et un peu de cumin à côté."] },

  { id: "chorba-legumes", name: "Chorba aux légumes et vermicelles", cat: "soupe", cui: "ma", time: 35, slots: ["midi", "soir"], diet: ["leger", "chol"],
    img: "https://thumb.wikimedia.org/wikipedia/commons/thumb/e/e5/Pile%C4%87a_corba.jpg/500px-Pile%C4%87a_corba.jpg", imgPage: "https://fr.wikipedia.org/wiki/Chorba",
    ing: [["carotte", 2, "pc"], ["courgette", 1, "pc"], ["pdt", 200, "g"], ["celeri", 1, "pc"], ["oignon", 1, "pc"], ["tomates_concassees", 1, "boite"], ["pois_chiches", 1, "boite"], ["vermicelles", 50, "g"], ["coriandre", 1, "botte"], ["citron", 1, "pc"]],
    pantry: ["cumin", "paprika", "curcuma", "huile d'olive", "sel", "poivre"],
    steps: ["Coupez les carottes, la courgette, 200 g de pommes de terre et la branche de céleri en petits dés. Hachez l'oignon.",
      "Dans une casserole, faites revenir l'oignon et les légumes dans 2 cuillères d'huile d'olive 5 minutes avec 1 cuillère à café de cumin, 1 de paprika, 1/2 de curcuma.",
      "Ajoutez la boîte de tomates, 1 litre d'eau, sel, poivre. Laissez mijoter 20 minutes.",
      "Ajoutez les pois chiches égouttés et 50 g de vermicelles, 4 minutes.",
      "Servez avec la coriandre ciselée et des quartiers de citron."] },

  { id: "taktouka", name: "Taktouka (poivrons grillés et tomates), œufs durs et pain", cat: "vege", cui: "ma", time: 30, slots: ["midi"], diet: ["leger"],
    ing: [["poivron", 4, "pc"], ["tomate", 4, "pc"], ["ail", 3, "gousse"], ["oeuf", 2, "pc"], ["coriandre", 1, "botte"], ["pain", 4, "tranche"]],
    pantry: ["cumin", "paprika", "huile d'olive", "sel", "poivre"],
    steps: ["Faites griller les 4 poivrons sous le gril du four 20 minutes en les tournant, jusqu'à ce que la peau noircisse. Enfermez-les 10 minutes sous un bol, pelez, épépinez et coupez-les en lanières.",
      "Pendant ce temps, faites cuire 2 œufs durs (9 minutes). Pelez les tomates (30 secondes dans l'eau bouillante) et concassez-les.",
      "Dans une poêle, faites chauffer 3 cuillères d'huile d'olive, ajoutez l'ail haché, les tomates, 1 cuillère à café de cumin, 1 de paprika, sel. Faites compoter 10 minutes.",
      "Ajoutez les poivrons, mélangez 5 minutes en écrasant un peu. Coriandre ciselée.",
      "Servez tiède avec les œufs durs coupés en deux et du pain. Se garde 3 jours au frais."] },

  { id: "salades-marocaines", name: "Assiette de salades marocaines (carottes au cumin, betterave, concombre)", cat: "salade", cui: "ma", time: 25, slots: ["midi"], diet: ["leger", "chol"],
    ing: [["carotte", 4, "pc"], ["betterave", 2, "pc"], ["concombre", 1, "pc"], ["tomate", 2, "pc"], ["citron", 2, "pc"], ["ail", 1, "gousse"], ["coriandre", 1, "botte"], ["persil", 1, "botte"], ["pain", 4, "tranche"]],
    pantry: ["cumin", "paprika", "huile d'olive", "sel", "poivre"],
    steps: ["Épluchez les 4 carottes, coupez-les en rondelles et faites-les cuire 10 minutes à l'eau bouillante salée : tendres mais fermes. Égouttez.",
      "Carottes au cumin : mélangez-les tièdes avec l'ail pressé, 1 cuillère à café de cumin, 1/2 de paprika, le jus d'un citron, 2 cuillères d'huile d'olive, la coriandre ciselée, sel.",
      "Betteraves : coupez les 2 betteraves cuites en dés, assaisonnez de citron, d'huile d'olive, d'une pincée de cumin et de persil.",
      "Concombre-tomates : dés de concombre et de tomates, citron, huile, sel, persil.",
      "Servez les trois salades côte à côte, à température ambiante, avec du pain."] },

  { id: "batbout-farcis", name: "Batbout farcis au poulet et crudités", cat: "volaille", cui: "ma", time: 25, slots: ["midi", "soir"], diet: ["leger", "chol"],
    ing: [["batbout", 4, "pc"], ["poulet_blanc", 300, "g"], ["tomate", 2, "pc"], ["concombre", 1, "pc"], ["laitue", 1, "pc"], ["oignon_rouge", 1, "pc"], ["citron", 1, "pc"], ["yaourt", 1, "pot"], ["coriandre", 1, "botte"]],
    pantry: ["cumin", "paprika", "curcuma", "huile d'olive", "sel", "poivre"],
    steps: ["Coupez 300 g de blanc de poulet en lanières, mélangez-les avec 1 cuillère à café de cumin, 1 de paprika, 1/2 de curcuma, le jus d'un demi-citron, 1 cuillère d'huile d'olive, sel, poivre.",
      "Faites-les griller 8 minutes dans une poêle bien chaude.",
      "Sauce : yaourt, coriandre ciselée, le reste du citron, sel. Coupez tomates et concombre en dés, l'oignon rouge en lamelles, la laitue en lanières.",
      "Ouvrez les batbout en poche (coupez un côté), réchauffez-les 30 secondes à la poêle.",
      "Garnissez de salade, poulet, crudités et sauce au yaourt."] },

  { id: "maakouda", name: "Maakouda (galettes de pommes de terre), salade de tomates", cat: "vege", cui: "ma", time: 40, slots: ["midi", "soir"],
    ing: [["pdt", 700, "g"], ["oeuf", 2, "pc"], ["ail", 2, "gousse"], ["persil", 1, "botte"], ["coriandre", 1, "botte"], ["farine", 40, "g"], ["tomate", 3, "pc"], ["oignon", 1, "pc"], ["citron", 1, "pc"]],
    pantry: ["cumin", "curcuma", "paprika", "huile", "huile d'olive", "sel", "poivre"],
    steps: ["Faites cuire 700 g de pommes de terre avec la peau 25 minutes à l'eau bouillante. Épluchez-les chaudes et écrasez-les.",
      "Mélangez avec 1 œuf, l'ail pressé, les herbes ciselées, 1 cuillère à café de cumin, 1/2 de curcuma, 1/2 de paprika, sel, poivre. Formez des galettes de 6 cm de diamètre et 1 cm d'épaisseur.",
      "Passez-les dans la farine puis dans le second œuf battu. Faites-les dorer 3 minutes par face dans 1 cm d'huile chaude. Égouttez sur du papier absorbant.",
      "Salade : tomates et oignon en dés, huile d'olive, citron, sel, un peu de coriandre.",
      "Servez les maakouda chaudes avec la salade et du citron. Excellentes aussi glissées dans un pain."] },

  { id: "bakoula", name: "Bakoula (épinards à la chermoula, olives et citron confit)", cat: "vege", cui: "ma", time: 30, slots: ["midi", "soir"], diet: ["leger", "chol"],
    ing: [["epinards", 600, "g"], ["ail", 4, "gousse"], ["coriandre", 1, "botte"], ["persil", 1, "botte"], ["olives_vertes", 80, "g"], ["citron_confit", 1, "pc"], ["citron", 1, "pc"], ["pain", 4, "tranche"], ["oeuf", 2, "pc"]],
    pantry: ["cumin", "paprika", "piment doux", "huile d'olive", "sel"],
    steps: ["Lavez 600 g d'épinards, faites-les tomber 3 minutes dans une grande casserole avec un fond d'eau, égouttez et pressez-les fortement, puis hachez-les.",
      "Dans une poêle, faites chauffer 4 cuillères d'huile d'olive, ajoutez l'ail haché, les herbes ciselées, 1 cuillère à café de cumin, 1 de paprika, une pointe de piment doux. 2 minutes.",
      "Ajoutez les épinards, le citron confit en petits dés et les olives. Faites revenir 10 minutes en remuant pour que le mélange s'assèche. Sel, jus de citron.",
      "Faites cuire 2 œufs durs (9 minutes), coupez-les en quartiers.",
      "Servez tiède ou froid avec les œufs et du pain."] },

  { id: "tajine-poulet-legumes", name: "Tajine de poulet aux légumes du marché", cat: "volaille", cui: "ma", time: 60, slots: ["soir"], diet: ["leger", "chol"],
    img: "https://thumb.wikimedia.org/wikipedia/commons/thumb/6/6d/Tajine_008.JPG/500px-Tajine_008.JPG", imgPage: "https://fr.wikipedia.org/wiki/Tajine",
    ing: [["poulet_haut", 4, "pc"], ["carotte", 3, "pc"], ["courgette", 2, "pc"], ["pdt", 400, "g"], ["tomate", 2, "pc"], ["oignon", 1, "pc"], ["ail", 2, "gousse"], ["coriandre", 1, "botte"], ["olives_vertes", 60, "g"], ["citron", 1, "pc"]],
    pantry: ["curcuma", "gingembre moulu", "cumin", "paprika", "huile d'olive", "sel", "poivre"],
    steps: ["Retirez la peau des hauts de cuisse. Faites-les dorer 4 minutes par face dans 2 cuillères d'huile d'olive avec l'oignon haché, l'ail, 1 cuillère à café de curcuma, 1 de gingembre, 1 de cumin, 1 de paprika, sel, poivre.",
      "Épluchez carottes et pommes de terre, coupez-les en bâtonnets ; courgettes en tronçons ; tomates en rondelles.",
      "Disposez les légumes en dôme sur le poulet (pommes de terre et carottes d'abord, courgettes et tomates dessus), la moitié de la coriandre, 20 cl d'eau. Couvrez et laissez cuire 40 minutes à feu doux sans remuer.",
      "Ajoutez les olives et le jus du citron 5 minutes avant la fin.",
      "Parsemez du reste de coriandre et servez avec du pain."] },

  { id: "couscous-tfaya", name: "Couscous tfaya (poulet, oignons caramélisés et raisins secs)", cat: "volaille", cui: "ma", time: 70, slots: ["soir"],
    img: "https://thumb.wikimedia.org/wikipedia/commons/thumb/e/eb/Tfaya.jpg/500px-Tfaya.jpg", imgPage: "https://fr.wikipedia.org/wiki/Tfaya",
    ing: [["poulet_cuisse", 2, "pc"], ["semoule", 200, "g"], ["oignon", 4, "pc"], ["raisins_secs", 80, "g"], ["pois_chiches", 1, "boite"], ["amandes", 40, "g"], ["miel", 2, "cs"], ["beurre", 30, "g"], ["bouillon", 1, "pc"]],
    pantry: ["cannelle", "ras el hanout", "curcuma", "gingembre moulu", "safran (ou curcuma)", "huile d'olive", "sel", "poivre"],
    steps: ["Faites dorer les 2 cuisses de poulet dans 1 cuillère d'huile avec 1 oignon haché, 1 cuillère à café de ras el hanout, 1 de curcuma, 1/2 de gingembre, une pincée de safran, sel, poivre. Couvrez de 60 cl d'eau avec le cube de bouillon, mijotez 40 minutes.",
      "Tfaya : émincez les 3 autres oignons, faites-les fondre 20 minutes à feu doux dans 30 g de beurre avec 80 g de raisins secs, 2 cuillères de miel, 1 cuillère à café de cannelle et une louche de bouillon, jusqu'à ce qu'ils soient confits et dorés.",
      "Ajoutez les pois chiches égouttés dans le bouillon du poulet 10 minutes avant la fin.",
      "Préparez 200 g de semoule (20 cl d'eau bouillante salée, 5 minutes à couvert, égrenée avec un filet d'huile). Faites griller 40 g d'amandes.",
      "Dressez la semoule, le poulet et les pois chiches, couvrez de tfaya, parsemez d'amandes. Bouillon à part."] },

  { id: "merguez-frites-salade", name: "Merguez grillées, frites au four et salade marocaine", cat: "viande", cui: "ma", time: 35, slots: ["midi", "soir"],
    img: "https://thumb.wikimedia.org/wikipedia/commons/thumb/f/f4/Merguez_grilled.jpg/500px-Merguez_grilled.jpg", imgPage: "https://fr.wikipedia.org/wiki/Merguez",
    ing: [["merguez", 6, "pc"], ["pdt", 600, "g"], ["tomate", 3, "pc"], ["concombre", 1, "pc"], ["oignon", 1, "pc"], ["coriandre", 1, "botte"], ["citron", 1, "pc"], ["pain", 4, "tranche"]],
    pantry: ["cumin", "paprika", "huile", "huile d'olive", "sel", "poivre"],
    steps: ["Préchauffez le four à 220 °C. Coupez 600 g de pommes de terre en frites, séchez-les, mélangez avec 2 cuillères d'huile, du paprika et du sel. Enfournez 30 minutes en retournant à mi-cuisson.",
      "Salade marocaine : tomates, concombre et oignon en petits dés, coriandre ciselée, jus de citron, 2 cuillères d'huile d'olive, une pincée de cumin, sel.",
      "Faites griller les 6 merguez de bœuf à la poêle ou au gril 8 à 10 minutes en les retournant, sans matière grasse.",
      "Servez merguez, frites et salade, avec du pain et un peu de cumin à côté."] },

  { id: "sardines-chermoula", name: "Sardines grillées à la chermoula, salade de tomates", cat: "poisson", cui: "ma", time: 25, slots: ["midi", "soir"], diet: ["leger", "chol"],
    ing: [["sardines", 600, "g"], ["ail", 3, "gousse"], ["coriandre", 1, "botte"], ["persil", 1, "botte"], ["citron", 2, "pc"], ["tomate", 3, "pc"], ["oignon", 1, "pc"], ["pain", 4, "tranche"]],
    pantry: ["cumin", "paprika", "piment doux", "huile d'olive", "sel", "poivre"],
    steps: ["Chermoula : mixez ou hachez finement la coriandre, le persil, 3 gousses d'ail, 1 cuillère à café de cumin, 1 de paprika, une pointe de piment doux, le jus d'un citron, 3 cuillères d'huile d'olive, sel.",
      "Demandez des sardines vidées et ouvertes en portefeuille (600 g). Enrobez-les de chermoula et laissez mariner 10 minutes.",
      "Faites-les griller 2 à 3 minutes par face sur une poêle-gril très chaude, au barbecue ou sous le gril du four.",
      "Salade : tomates et oignon en dés, huile d'olive, le second citron, sel.",
      "Servez aussitôt avec la salade et du pain."] },

  { id: "poulet-pdt-four-marocain", name: "Poulet et pommes de terre au four aux épices marocaines", cat: "volaille", cui: "ma", time: 60, slots: ["soir"], diet: ["leger", "chol"],
    img: "https://thumb.wikimedia.org/wikipedia/commons/thumb/d/d9/Max%27s_Roasted_Chicken_-_Evan_Swigart.jpg/500px-Max%27s_Roasted_Chicken_-_Evan_Swigart.jpg", imgPage: "https://fr.wikipedia.org/wiki/Poulet_r%C3%B4ti",
    ing: [["poulet_haut", 4, "pc"], ["pdt", 700, "g"], ["oignon", 2, "pc"], ["ail", 4, "gousse"], ["citron", 1, "pc"], ["citron_confit", 1, "pc"], ["olives_vertes", 60, "g"], ["coriandre", 1, "botte"]],
    pantry: ["cumin", "paprika", "curcuma", "gingembre moulu", "huile d'olive", "sel", "poivre"],
    steps: ["Préchauffez le four à 200 °C. Mélangez 2 cuillères d'huile d'olive avec 1 cuillère à café de cumin, 1 de paprika, 1 de curcuma, 1/2 de gingembre, l'ail pressé, le jus du citron, sel, poivre.",
      "Retirez la peau des hauts de cuisse. Épluchez 700 g de pommes de terre et coupez-les en quartiers, les oignons en gros quartiers. Enrobez tout de la marinade dans un grand plat, poulet sur le dessus.",
      "Versez 15 cl d'eau dans le fond, ajoutez le citron confit en morceaux. Enfournez 45 minutes en retournant les pommes de terre à mi-cuisson.",
      "Ajoutez les olives 5 minutes avant la fin. Parsemez de coriandre ciselée et servez."] },

  /* ---------- Autres cuisines (suite) ---------- */
  { id: "soupe-pistou", name: "Soupe au pistou", cat: "soupe", cui: "fr", time: 45, slots: ["soir"], diet: ["leger", "chol"],
    img: "https://thumb.wikimedia.org/wikipedia/commons/thumb/1/14/Pistour-4.JPG/500px-Pistour-4.JPG", imgPage: "https://fr.wikipedia.org/wiki/Soupe_au_pistou",
    ing: [["haricots_blancs", 1, "boite"], ["haricots_verts", 200, "g"], ["courgette", 1, "pc"], ["pdt", 200, "g"], ["carotte", 1, "pc"], ["tomate", 2, "pc"], ["oignon", 1, "pc"], ["pates", 80, "g"], ["basilic", 1, "botte"], ["ail", 3, "gousse"], ["parmesan", 30, "g"]],
    pantry: ["huile d'olive", "sel", "poivre"],
    steps: ["Coupez la courgette, 200 g de pommes de terre, la carotte et les tomates en dés, les haricots verts en tronçons, émincez l'oignon.",
      "Dans une grande casserole, faites suer l'oignon dans 1 cuillère d'huile d'olive, ajoutez tous les légumes sauf les tomates, 1,2 litre d'eau, sel. Laissez cuire 20 minutes.",
      "Ajoutez les tomates, les haricots blancs égouttés et 80 g de petites pâtes, 10 minutes.",
      "Pistou : pilez ou mixez le basilic avec 3 gousses d'ail, 4 cuillères d'huile d'olive et 30 g de parmesan.",
      "Servez la soupe, chacun ajoute une cuillère de pistou dans son bol."] },

  { id: "daube-olives", name: "Daube de bœuf aux olives et à l'orange (sans vin)", cat: "viande", cui: "fr", time: 120, slots: ["soir"],
    ing: [["boeuf_braiser", 600, "g"], ["carotte", 3, "pc"], ["oignon", 1, "pc"], ["ail", 3, "gousse"], ["tomates_concassees", 1, "boite"], ["olives_noires", 100, "g"], ["orange", 1, "pc"], ["bouillon", 1, "pc"], ["farine", 20, "g"], ["pates", 200, "g"]],
    pantry: ["thym", "laurier", "clous de girofle", "huile d'olive", "sel", "poivre"],
    steps: ["Coupez 600 g de bœuf en gros cubes, salez, poivrez. Faites-les colorer dans 2 cuillères d'huile d'olive dans une cocotte, par petites quantités. Réservez.",
      "Faites fondre l'oignon émincé et les carottes en rondelles 5 minutes. Remettez la viande, saupoudrez de 20 g de farine, mélangez 1 minute.",
      "Ajoutez la boîte de tomates, 40 cl de bouillon, l'ail, le thym, le laurier, 2 clous de girofle et 2 larges zestes d'orange (sans la partie blanche). Couvrez et laissez mijoter 1 h 45 à feu très doux.",
      "Ajoutez les olives noires 15 minutes avant la fin. La viande doit être fondante et la sauce épaisse.",
      "Servez avec des pâtes (macaronis ou tagliatelles), comme en Provence."] },

  { id: "tarte-courgettes-chevre", name: "Tarte aux courgettes et au chèvre", cat: "oeufs", cui: "fr", time: 50, slots: ["midi", "soir"],
    ing: [["pate_feuilletee", 1, "pc"], ["courgette", 2, "pc"], ["chevre", 150, "g"], ["oeuf", 2, "pc"], ["creme", 15, "cl"], ["oignon", 1, "pc"], ["laitue", 1, "pc"]],
    pantry: ["thym", "moutarde", "huile d'olive", "vinaigre", "sel", "poivre"],
    steps: ["Préchauffez le four à 190 °C. Coupez les 2 courgettes en fines rondelles, émincez l'oignon, faites-les sauter 8 minutes dans 1 cuillère d'huile d'olive jusqu'à évaporation de l'eau. Salez, poivrez.",
      "Déroulez la pâte feuilletée dans un moule, piquez-la, tartinez d'une fine couche de moutarde.",
      "Battez 2 œufs avec 15 cl de crème, sel, poivre, thym. Répartissez les courgettes sur la pâte, versez l'appareil, posez le chèvre en rondelles.",
      "Enfournez 30 minutes jusqu'à ce que la tarte soit dorée. Servez avec la laitue en vinaigrette."] },

  { id: "spaghetti-fruits-mer", name: "Spaghetti aux fruits de mer (sans vin)", cat: "poisson", cui: "it", time: 30, slots: ["soir"], diet: ["leger"],
    img: "https://thumb.wikimedia.org/wikipedia/commons/thumb/5/59/Spaghetti_vongole_2.jpg/500px-Spaghetti_vongole_2.jpg", imgPage: "https://en.wikipedia.org/wiki/Spaghetti_alle_vongole",
    ing: [["spaghetti", 200, "g"], ["crevettes", 200, "g"], ["moules", 500, "g"], ["calamars", 150, "g"], ["tomates_cerises", 200, "g"], ["ail", 3, "gousse"], ["persil", 1, "botte"], ["citron", 1, "pc"]],
    pantry: ["piment (flocons)", "huile d'olive", "sel", "poivre"],
    steps: ["Nettoyez 500 g de moules. Faites-les ouvrir 4 minutes dans une casserole couverte avec 5 cl d'eau, en secouant. Filtrez et gardez le jus, décoquillez la moitié.",
      "Faites cuire 200 g de spaghetti al dente.",
      "Dans une grande poêle, faites dorer 3 gousses d'ail émincées dans 3 cuillères d'huile d'olive avec une pincée de piment. Ajoutez les calamars en anneaux 2 minutes, les crevettes 2 minutes, les tomates cerises coupées en deux 2 minutes.",
      "Versez le jus des moules, les moules, les pâtes égouttées et une louche d'eau de cuisson. Mélangez 1 minute à feu vif.",
      "Persil ciselé, zeste et jus d'un demi-citron, poivre. Servez aussitôt."] },

  { id: "poulet-cacciatore", name: "Poulet à la cacciatore (chasseur, sans vin)", cat: "volaille", cui: "it", time: 60, slots: ["soir"], diet: ["chol"],
    img: "https://thumb.wikimedia.org/wikipedia/commons/thumb/8/83/Hunter%27s_chicken_%282%29.jpg/500px-Hunter%27s_chicken_%282%29.jpg", imgPage: "https://fr.wikipedia.org/wiki/Poulet_chasseur",
    ing: [["poulet_haut", 4, "pc"], ["champignons", 250, "g"], ["poivron", 1, "pc"], ["oignon", 1, "pc"], ["ail", 2, "gousse"], ["tomates_concassees", 1, "boite"], ["olives_noires", 60, "g"], ["bouillon", 1, "pc"], ["pates", 200, "g"]],
    pantry: ["romarin", "origan", "huile d'olive", "sel", "poivre"],
    steps: ["Salez et poivrez les 4 hauts de cuisse, faites-les dorer 5 minutes par face dans 2 cuillères d'huile d'olive. Réservez.",
      "Faites revenir l'oignon émincé, le poivron en lanières et l'ail 5 minutes, puis les champignons en quartiers 5 minutes à feu vif.",
      "Ajoutez la boîte de tomates, 15 cl de bouillon, le romarin et l'origan. Remettez le poulet, couvrez, mijotez 30 minutes. Découvrez et ajoutez les olives les 10 dernières minutes.",
      "Faites cuire 200 g de pâtes et servez avec le poulet et sa sauce."] },

  { id: "poulet-korma", name: "Poulet korma aux amandes", cat: "volaille", cui: "in", time: 40, slots: ["soir"],
    img: "https://thumb.wikimedia.org/wikipedia/commons/thumb/a/a7/Flickr_-_cyclonebill_-_Lamb_Korma%2C_raita%2C_Masoor_Dal%2C_guler%C3%B8dder_og_chapati.jpg/500px-Flickr_-_cyclonebill_-_Lamb_Korma%2C_raita%2C_Masoor_Dal%2C_guler%C3%B8dder_og_chapati.jpg", imgPage: "https://fr.wikipedia.org/wiki/Korma",
    ing: [["poulet_blanc", 400, "g"], ["yaourt", 1, "pot"], ["amandes", 50, "g"], ["lait_coco", 20, "cl"], ["oignon", 2, "pc"], ["ail", 3, "gousse"], ["gingembre", 20, "g"], ["riz_basmati", 150, "g"], ["coriandre", 1, "botte"]],
    pantry: ["garam masala", "curcuma", "cardamome", "cannelle", "cumin", "huile", "sel"],
    steps: ["Coupez 400 g de poulet en cubes, mélangez-les avec le yaourt, 1 cuillère à café de garam masala et 1/2 de curcuma. Laissez mariner 15 minutes.",
      "Mixez 50 g d'amandes avec 10 cl d'eau en pâte. Faites cuire 150 g de riz basmati.",
      "Faites fondre les 2 oignons émincés 8 minutes dans 2 cuillères d'huile, ajoutez l'ail, le gingembre râpé, 3 gousses de cardamome, une pincée de cannelle et 1 cuillère à café de cumin, 1 minute.",
      "Ajoutez le poulet avec sa marinade, 5 minutes, puis la pâte d'amandes et 20 cl de lait de coco. Laissez mijoter 15 minutes à feu doux. Salez.",
      "Servez sur le riz avec la coriandre."] },

  { id: "nasi-goreng", name: "Nasi goreng (riz sauté indonésien) au poulet", cat: "pates", cui: "as", time: 25, slots: ["midi", "soir"], diet: ["leger"],
    img: "https://thumb.wikimedia.org/wikipedia/commons/thumb/d/d8/Nasi_Goreng_Sosis.jpg/500px-Nasi_Goreng_Sosis.jpg", imgPage: "https://fr.wikipedia.org/wiki/Nasi_goreng",
    ing: [["riz", 150, "g"], ["poulet_blanc", 200, "g"], ["oeuf", 2, "pc"], ["chou_vert", 1, "pc"], ["carotte", 1, "pc"], ["oignon_nouveau", 3, "pc"], ["ail", 2, "gousse"], ["sauce_soja", 3, "cs"], ["miel", 1, "cs"], ["concombre", 1, "pc"]],
    pantry: ["sauce pimentée (sriracha ou pâte de piment)", "huile", "sel"],
    steps: ["Faites cuire 150 g de riz (idéalement la veille, le riz froid saute mieux). Sauce : 3 cuillères de sauce soja, 1 de miel, 1 cuillère à café de sauce pimentée.",
      "Coupez le poulet en petits dés, un quart de chou et la carotte en fines lanières, émincez les oignons nouveaux et l'ail.",
      "Dans un wok très chaud avec 1 cuillère d'huile, saisissez le poulet 4 minutes. Ajoutez l'ail, le chou et la carotte, 3 minutes.",
      "Ajoutez le riz et la sauce, faites sauter 3 minutes à feu vif. Oignons nouveaux.",
      "Faites frire 2 œufs au plat, posez-en un sur chaque assiette. Servez avec des rondelles de concombre."] },

  { id: "larb-poulet", name: "Larb de poulet (salade thaï aux herbes et citron vert)", cat: "salade", cui: "as", time: 25, slots: ["midi"], diet: ["leger", "chol"],
    ing: [["poulet_blanc", 300, "g"], ["citron_vert", 2, "pc"], ["nuoc_mam", 2, "cs"], ["oignon_rouge", 1, "pc"], ["menthe", 1, "botte"], ["coriandre", 1, "botte"], ["laitue", 1, "pc"], ["riz", 30, "g"]],
    pantry: ["piment (flocons)", "sucre", "huile"],
    steps: ["Faites griller 30 g de riz cru à sec dans une poêle jusqu'à ce qu'il soit doré, puis réduisez-le en poudre grossière (mortier ou mixeur) : c'est le khao khua, qui donne le goût.",
      "Hachez 300 g de blanc de poulet au couteau. Faites-le cuire 5 minutes dans une poêle avec 5 cl d'eau (pas d'huile), en l'émiettant. Égouttez.",
      "Mélangez le poulet tiède avec le jus des 2 citrons verts, 2 cuillères de nuoc-mâm, une pincée de sucre, une pincée de piment, l'oignon rouge émincé, la menthe et la coriandre effeuillées, la poudre de riz.",
      "Servez dans des feuilles de laitue, à manger avec les doigts."] },

  { id: "kofte-boulgour", name: "Köfte à la turque, boulgour aux tomates et yaourt", cat: "viande", cui: "med", time: 35, slots: ["soir"],
    img: "https://thumb.wikimedia.org/wikipedia/commons/thumb/a/a2/Sultanahmet_K%C3%B6ftesi.jpg/500px-Sultanahmet_K%C3%B6ftesi.jpg", imgPage: "https://fr.wikipedia.org/wiki/Kefta",
    ing: [["boeuf_hache", 400, "g"], ["oignon", 2, "pc"], ["persil", 1, "botte"], ["boulgour", 150, "g"], ["tomate", 3, "pc"], ["yaourt", 1, "pot"], ["ail", 1, "gousse"], ["citron", 1, "pc"]],
    pantry: ["cumin", "paprika", "menthe séchée", "piment (flocons)", "huile d'olive", "sel", "poivre"],
    steps: ["Boulgour : faites revenir 1 oignon haché dans 1 cuillère d'huile, ajoutez 150 g de boulgour et 2 tomates en dés, 30 cl d'eau, sel. Couvrez, 12 minutes à feu doux, puis 5 minutes de repos.",
      "Mélangez 400 g de bœuf haché avec l'autre oignon râpé et pressé, le persil ciselé, 1 cuillère à café de cumin, 1 de paprika, 1 de menthe séchée, une pincée de piment, sel, poivre. Formez des boudins ovales aplatis.",
      "Faites griller 4 minutes par face sur une poêle-gril chaude.",
      "Sauce : yaourt, ail pressé, sel. Tomate restante en quartiers.",
      "Servez les köfte sur le boulgour, avec le yaourt à l'ail et du citron."] },

  { id: "chili-poulet-blanc", name: "Chili blanc au poulet et haricots blancs", cat: "volaille", cui: "mx", time: 45, slots: ["soir"], diet: ["leger", "chol"],
    ing: [["poulet_blanc", 400, "g"], ["haricots_blancs", 2, "boite"], ["oignon", 1, "pc"], ["ail", 3, "gousse"], ["poivron", 1, "pc"], ["bouillon", 1, "pc"], ["citron_vert", 1, "pc"], ["coriandre", 1, "botte"], ["yaourt", 1, "pot"], ["tortillas", 2, "pc"]],
    pantry: ["cumin", "origan", "piment (flocons)", "huile d'olive", "sel", "poivre"],
    steps: ["Faites revenir l'oignon haché, l'ail et le poivron en dés dans 1 cuillère d'huile d'olive 5 minutes, avec 1 cuillère à café de cumin, 1 d'origan et une pincée de piment.",
      "Ajoutez 400 g de blanc de poulet entier et 50 cl de bouillon. Laissez frémir 15 minutes, retirez le poulet, effilochez-le à la fourchette.",
      "Ajoutez les 2 boîtes de haricots blancs égouttés ; écrasez-en une partie à la cuillère pour épaissir. Remettez le poulet, 10 minutes. Sel, poivre.",
      "Terminez avec le jus du citron vert et la coriandre ciselée.",
      "Servez avec une cuillère de yaourt et des tortillas grillées coupées en triangles."] },
];
